...
namespace Accelbuffer.Compiling.Declarations
{
    ...
    /// </summary>
    [MemorySize(120)]
    [SerializeBy(typeof(UsingDeclaration.UsingDeclarationSerializer))]
    public sealed partial class UsingDeclaration
    {
...
partial void OnAfterDeserialization();
        ...
        /// 反序列化对象
        /// </summary>
        public static UsingDeclaration FromBytes(byte[] bytes)
        {
return Serializer.Deserialize<UsingDeclaration>(bytes, 0, bytes.Length);
        }
        
        /// <summary>
        /// 对象序列化代理（自动生成）
        /// </summary>
        public sealed class UsingDeclarationSerializer : object, ITypeSerializer<UsingDeclaration>
        {
            
            /// <summary>
            /// 序列化方法（自动生成）
            /// </summary>
            public void Serialize(UsingDeclaration obj, ref AccelWriter writer)
            {
            ...
            /// 反序列化方法（自动生成）
            /// </summary>
            public UsingDeclaration Deserialize(ref AccelReader reader)
            {
                UsingDeclaration result = new UsingDeclaration();
                int index;
